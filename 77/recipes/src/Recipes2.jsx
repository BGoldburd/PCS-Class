...
class Recipes2 extends Component {
    ...
    render() { 
        const selectedRecipe = this.state.selectedRecipe ? <RecipeDetails onChange={this.update} onRemove={this.remove} index={this.state.selectedRecipe.id} className="recipes2" color="yellow" recipe={this.state.selectedRecipe}/> : null;
